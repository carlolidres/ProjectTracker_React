...
export interface ProjectFieldDef {
  ...
  tooltip?: string;
  registry?: string;
  /** Searchable select that can save/reuse/delete registry suggestions. */
  creatable?: boolean;
  span?: 1 | 2 | 3;
...
export const HEADER_FIELDS: ProjectFieldDef[] = [
  ...
  { key: "project_owner", label: "Project Owner", type: "select", role: "AM/BM/PL", registry: "project_owner", creatable: true, tooltip: "Set automatically from your profile first name when you create a project. Admins may assign any owner." },
...
export const PO_FIELDS: ProjectFieldDef[] = [
  ...
  { key: "business_unit", label: "Business Unit", type: "select", role: "AM/BM/PL", registry: "business_unit", creatable: true, tooltip: "CM, BM, or PL." },
