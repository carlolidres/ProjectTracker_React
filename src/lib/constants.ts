...
export const DEFAULT_REGISTRY: Record<string, string[]> = {
  ...
  validation_report_status: ["In-process", "Routing", "Client Approval", "Approved", "Not Applicable"],
  ...
  doc_status: ["In-process", "Routing", "Client Approval", "Approved", "Not Applicable"],
