...
import { AM_CNF_ENTRY_KEYS } from "@/lib/constants";
import type { UserRole } from "@/types";

export type SpreadsheetFieldGroup = "am" | "pp" | "tsd" | "val" | "qc";
...
const FIELD_LOOKUP = new Map(
  [...HEADER_FIELDS, ...PO_FIELDS, { key: "unique_batch", label: "Unique Batch", type: "alphanumeric" as const, role: "AM/BM/PL" as const }].map(
    (f) => [f.key, f],
  ),
);
...
export const PROJECTS_DB_DATA_COLUMNS: SpreadsheetColumnDef[] = [
  ...
  col("so_no", { roleGroup: "am", roleGroupLabel: "AM/BM/PL", fieldGroup: "am", level: "po", width: 110 }),
  ...
  col("change_description", { roleGroup: "am", roleGroupLabel: "AM/BM/PL", fieldGroup: "am", level: "cnf", headerName: "Change", width: 160 }),
  ...
  col("remarks", { roleGroup: "am", roleGroupLabel: "AM/BM/PL", fieldGroup: "am", level: "cnf", headerName: "Remarks/Concerns", width: 160 }),
...
export const CNF_SPREADSHEET_FIELDS = new Set<string>(AM_CNF_ENTRY_KEYS);
